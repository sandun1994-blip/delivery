...
import { DestinationContext, OriginalContext } from '../contexts/context';
...
const {dispatchOrigin,origin} =useContext(OriginalContext)
const {dispatchDestination,destination} =useContext(DestinationContext)
    ...
    return (
        <View style={styles.container}>
            <View style={styles.view1}>
                <Icon
                    type='material-community' name='arrow-left'
                    color={colors.grey1}
                    size={32}
